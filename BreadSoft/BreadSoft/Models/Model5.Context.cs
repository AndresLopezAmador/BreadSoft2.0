...
namespace BreadSoft.Models
{
    ...
    public partial class BreadSoftv2Entities2 : DbContext
    {
        public BreadSoftv2Entities2()
            : base("name=BreadSoftv2Entities2")
        {
        }
        ...
        public virtual ObjectResult<mostrarDetalleVenta_Result> mostrarDetalleVenta(Nullable<int> idVenta)
        {
            var idVentaParameter = idVenta.HasValue ?
                new ObjectParameter("idVenta", idVenta) :
                new ObjectParameter("idVenta", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<mostrarDetalleVenta_Result>("mostrarDetalleVenta", idVentaParameter);
        }
